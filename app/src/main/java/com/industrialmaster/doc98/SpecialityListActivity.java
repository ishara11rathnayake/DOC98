...
public class SpecialityListActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        final ListView lv = findViewById(R.id.speciality_list);
        ...
        JsonArrayRequest request1 = new JsonArrayRequest(Request.Method.GET, url,
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter(SpecialityListActivity.this, layout, list);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SpecialityListActivity.this, "Error :"+error, Toast.LENGTH_SHORT).show();
                    }
                });
